...
function RegisterForm() {
  ...
  return (
    <form onSubmit={handleRegister} className="bg-slate-800/50 border border-slate-700 rounded-xl p-8">
      {error && (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">Skapa ett nytt konto</p>
        </div>
        ...
        <Suspense fallback={
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-8 animate-pulse">
            ...
            <div className="h-10 bg-slate-700 rounded mb-4" />
            <div className="h-10 bg-slate-700 rounded mb-6" />

      ...
      <div className="h-12 px-6 flex items-center justify-between border-b border-slate-100">
        ...
        {projectId && (
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-2 px-3 py-1.5 text-sm text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-colors">
            ...
            >
              ...
              <span className="hidden sm:inline">Ny avvikelse</span>
            </button>
          </div>
        )}
      </div>

      {/* Bottom Row - Search & User */}
            ...
            <AnimatePresence>
              {showNotifications && (
                <motion.div
                  ...
                  className="absolute right-0 mt-2 w-96 bg-white/95 backdrop-blur-xl border border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 z-50 overflow-hidden"
                >
                  {/* Header */}
            ...
            <AnimatePresence>
              {showDropdown && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10, scale: 0.95 }}
                  transition={{ duration: 0.15 }}
                  className="absolute right-0 mt-2 w-56 bg-white/95 backdrop-blur-xl border border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 py-2 z-50 overflow-hidden"
                >
                  {/* User Info */}

...
const navigation = [
  ...
  { name: 'Dokument', href: '/dashboard/documents', icon: DocumentIcon },
  { name: 'Avvikelser', href: '/dashboard/issues', icon: ExclamationIcon },
  { name: 'Ritningar', href: '/dashboard/drawings', icon: MapIcon },
  { name: 'Checklistor', href: '/dashboard/checklists', icon: ClipboardIcon },
]

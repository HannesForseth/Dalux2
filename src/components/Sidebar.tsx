...
const projectNavigation = [
  ...
  { name: 'Ärenden', href: '/issues', icon: ExclamationIcon },
  { name: 'Avvikelser', href: '/deviations', icon: ShieldExclamationIcon },
  { name: 'Checklistor', href: '/checklists', icon: ClipboardIcon },
  { name: 'Frågor & Svar', href: '/rfi', icon: ChatIcon },
  { name: 'Protokoll', href: '/protocols', icon: ClipboardDocumentListIcon },
]

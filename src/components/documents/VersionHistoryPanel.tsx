    ...
    <div className="p-4">
        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-indigo-600 font-medium">Aktuell</span>
            </div>
            <p className="text-sm text-slate-600 mt-1">Nuvarande version</p>
          </div>
      ...
      {versions.length === 0 ? (
        <div className="text-center py-6">
          <p className="text-sm text-slate-700 font-medium">Ingen versionshistorik</p>
          <p className="text-xs mt-1 text-slate-600">Versioner sparas när du laddar upp nya filer</p>
        </div>
      ) : (
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {version.change_note && (
                    <p className="text-sm text-slate-600 mt-1 italic">
                      &ldquo;{version.change_note}&rdquo;
                    </p>
                  )}
